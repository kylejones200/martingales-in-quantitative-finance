...
def simulate_binomial_tree(S0: float, u: float, d: float, r: float, steps: int, seed: int | None=None) -> list:
...
def simulate_exponential_martingale(theta: float, T: float, steps: int, seed: int | None=None) -> tuple[np.ndarray, np.ndarray, np.ndarray]:
...
def simulate_girsanov(theta: float, T: float, steps: int, seed: int | None=None) -> tuple[np.ndarray, np.ndarray, np.ndarray]:
